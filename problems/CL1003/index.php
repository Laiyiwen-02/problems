...
<html>
  ...
  <body>
    <div style="padding-left:10%;padding-right:10%;"><div style = "padding:2%; margin:2%; color:black; text-align:center;"><h1>CL1003</h1></div>
    <div class="layui-tabs layui-tabs-card" style="padding:2%;margin:2%;" lay-options="{index:0}">
      <ul class="layui-tabs-header">
        <li>题目描述</li>
        <li>题解</li>
        <li>附件下载</li>
        <li style="float:right;"><a href="/problems/CL1003/submit.php" class="layui-btn">添加题解</a></li>
      </ul>
